...
- [x] 4.2 (P) AlphaBetaにムーブオーダリングを適用
...
- [x] 10. ベンチマークとプロファイリング
- [x] 10.1 (P) 探索ベンチマークの実装
...
- [x] 11.2 探索パフォーマンス要件の検証
  ...
  - 探索システムがメモリ使用量350MB以内に収めることを確認（置換表256MB + 評価テーブル70MB含む）
  - _Requirements: 15.1, 15.2, 15.3, 15.4, 15.5, 15.6, 15.7_

- [x] 11.3 Phase 3への引き継ぎドキュメント作成
